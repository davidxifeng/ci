...
local function new_stack()
  return {
    ...
    get_sp = function(self)
      return self.sp
    end,
    set_sp = function(self, value)
      self.sp = value
    end,
  }
end
...
local function new_text(p)
  return {
    ...
    current_pc = function (self)
      return self.pc
    end,
    current_pc_value = function (self)
      return self.data[self.pc]
    end,
    add_pc_by = function (self, value)
      self.pc = self.pc + value
    end,
    set_pc = function (self, value)
      self.pc = value
    end,
  }
end
